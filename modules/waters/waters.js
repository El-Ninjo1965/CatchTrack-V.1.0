...
window.CatchTrackWatersModule = {
    ...
    getDatabase() {
        if (
            ...
            typeof window.CatchTrackDatabase.isReady ===
                "function" &&
            window.CatchTrackDatabase.isReady()
        ) {
    ...
    async requestGPSPosition() {
        ...
        if (this.state.gpsBusy) {
            throw new Error(
                "Eine Standortbestimmung läuft bereits."
            );
        }
    ...
    async reverseGeocode(
        ...
        for (
            ...
            try {
                ...
                this.handleError(
                    error,
                    "waters:reverse-geocode-provider"
                );
            }
        }
    ...
    async autoFillLocation() {
        ...
        this.setGPSMessage(
            "GPS, Land und Region/Ort werden ermittelt …",
            "info"
        );
        ...
        try {
            ...
            if (
                ...
                this.setGPSMessage(
                    "GPS, Land und Region/Ort wurden automatisch übernommen.",
                    "success"
                );
            }
            else {
    ...
    async updateGPS() {
        ...
        try {
            ...
            if (
                ...
                this.setGPSMessage(
                    "GPS, Land und Region/Ort wurden aktualisiert.",
                    "success"
                );
            }
            else {
    ...
    async useGPSForForm() {
        ...
        try {
            ...
            if (
                ...
                this.setFormMessage(
                    "GPS, Land und Region/Ort wurden übernommen.",
                    "success"
                );
            }
            else {
    ...
    renderNearby() {
        ...
        if (!nearby.length) {
            ...
            empty.textContent =
                "Keine gespeicherten Gewässer im Umkreis von 50 km gefunden.";
