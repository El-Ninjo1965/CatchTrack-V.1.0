...
(() => {
    ...
    const TRANSLATIONS = {
        ...
        de: {
            ...
            'gps.r_status':   'Status',
            'gps.r_sim':      'Simuliert',
            'gps.test_title': 'Test – Simulierte Position',
            'gps.test_head':  '🧪 Testposition',
            'gps.test_desc':  'Setzt eine simulierte GPS-Position für Tests ohne reale Hardware. Der produktive Geolocation-Datenfluss wird nicht verändert.',
            'gps.sim_btn':    'Simulieren',
            'gps.sim_clear':  'Simulation löschen',
            'gps.f_lat':      'Latitude',
            'gps.f_lon':      'Longitude',
            'gps.f_name':     'Name',
            'gps.d_lat':      'Latitude',
        ...
        en: {
            ...
            'gps.r_status':   'Status',
            'gps.r_sim':      'Simulated',
            'gps.test_title': 'Test – Simulated Position',
            'gps.test_head':  '🧪 Test Position',
            'gps.test_desc':  'Sets a simulated GPS position for testing without real hardware. The live geolocation flow is not affected.',
            'gps.sim_btn':    'Simulate',
            'gps.sim_clear':  'Clear Simulation',
            'gps.f_lat':      'Latitude',
            'gps.f_lon':      'Longitude',
            'gps.f_name':     'Name',
            'gps.d_lat':      'Latitude',
